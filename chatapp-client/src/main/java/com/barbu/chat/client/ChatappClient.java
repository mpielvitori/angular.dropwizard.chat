...
public class ChatappClient {
    ...
    public ChatappClient(Client client, URI root) {
        this.client = client;
        this.clientBuilder = null;
        this.root = root;
    }

    public ChatappClient(JerseyClientBuilder clientBuilder, URI root) {
        this.client = null;
    ...
    private static Client buildClient(JerseyClientBuilder clientBuilder) {
        ...
        return builder
            ...
            .using(jerseyConfig).build("chatappClient");
    }
}
